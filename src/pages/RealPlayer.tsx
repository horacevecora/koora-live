...
export default function RealPlayer() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center pt-6 px-6 pb-6 sm:px-10 sm:pb-10 font-sans relative overflow-hidden">
      <div className="absolute top-6 left-8 right-8 flex justify-between items-center z-50 pointer-events-none">
      ...
      <footer className="w-full max-w-[1150px] mt-8 pb-6 flex flex-col items-center gap-2 text-[11px] text-slate-500 px-4">
