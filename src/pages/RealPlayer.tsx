...
export default function RealPlayer() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center pt-16 px-6 md:px-24 pb-2 font-sans relative overflow-hidden">
      <div className="absolute top-6 left-12 right-12 flex justify-between items-center z-50 pointer-events-none">
      ...
      {/* المشغل مع زيادة المسافة العلوية */}
      <div 
        id="main-player-wrapper" 
        className="w-full max-w-[1200px] rounded-2xl mt-8 bg-black flex flex-col relative transition-all duration-500 border border-indigo-500/20 shadow-[0_0_60px_-15px_rgba(99,102,241,0.3)]"
      >
      ...
      {/* التذييل بمسافات أقل جداً في الأسفل */}
      <footer className="w-full max-w-[1200px] mt-6 pb-2 flex flex-col items-center gap-2 text-[11px] text-slate-500 px-4">
