      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex justify-between items-center">
          ...
          <Button 
            ...
            className="text-red-400 border-red-900/30 bg-red-900/10 hover:bg-red-900/20"
          >
                ...
                <div key={s.id} className="flex justify-between p-3 bg-slate-900/60 rounded">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className={s.active ? "text-emerald-500" : "text-slate-600"}
                    >
                      <CheckCircle2 size={16} />
                    </button>
                    <button onClick={() => startEditScript(s)}>
                      <Edit2 size={16} />
                    </button>
                    <button 
